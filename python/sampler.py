...
for nf in dataloader:
    ...
    def forward_pass(distributed_input, per_gpu_conv_list, local_graphs, merge_indices):
        ...
        return out
    t1 = time.time()
    out1 = forward_pass(local_features,conv1, local_graphs[0],merge_indices[0])
    out2 = forward_pass(out1,conv2, local_graphs[1],merge_indices[1])
    if hops==3:
        out3 = forward_pass(out2,conv3,local_graphs[2],merge_indices[2])
