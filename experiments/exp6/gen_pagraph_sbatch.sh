...
SLURMJOBNAME=gbmc_$GRAPH\_$BATCH\_$MODEL\_$CACHE
echo $SLURMJOBNAME
DIR=/home/spolisetty_umass_edu/OCC-GNN/experiments/exp6/slurm-log
mkdir -p $DIR
...
echo "cd \$HOME; python3 experiments/exp6/pagraph.py --graph $GRAPH --cache-per $CACHE --model $MODEL --batch-size $BATCH" >> $JOBFILE 
